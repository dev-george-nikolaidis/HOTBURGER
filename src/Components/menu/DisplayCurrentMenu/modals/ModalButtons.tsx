...
<Wrapper>
     ...
     {menuCategory.toLocaleUpperCase() === MenuProductCategory.BEEF_BURGER ? <button className= {temperature !== null ? "btn-cta" : "btn-cta btn-disabled"} disabled = { temperature ? false: true } onClick={btnClickHandler}> Add to cart</button> :  <button className= "btn-cta"  onClick={btnClickHandler}> Add to cart</button>  } 
